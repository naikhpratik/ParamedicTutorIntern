//
//  CardiologyQuestionViewController-iPad.m
//  Paramedic
//
...
#import "CardiologyExplanationViewController-iPad.h"
#import "CardiologyBean.h"
#import "SqlMB.h"


@interface CardiologyQuestionViewController_iPad () <CardiologyExplanationViewControllerDelegate>
{
...
@implementation CardiologyQuestionViewController_iPad
...
-(void) updateQuestionView
{
    ...
    NSArray * tokensArray = [bean.question componentsSeparatedByString:@".png"];
    [self.questionImageView setImage:[UIImage imageNamed:[NSString stringWithFormat:@"%@_ipad.png", [tokensArray objectAtIndex:0]]]];
...
- (IBAction)hintOrExplanationButtonTapped:(id)sender{
    ...
    CardiologyExplanationViewController_iPad *explanationViewController = [[CardiologyExplanationViewController_iPad alloc] initWithNibName:kiPadCardiologyExplanationControllerNibName bundle:nil];
...
-(void)reloadQuestionScreen:(id)sender WithQuestionNumber:(int)questionNumber{
    if (![sender isKindOfClass:[CardiologyExplanationViewController_iPad class]]) {
        return;
    }
