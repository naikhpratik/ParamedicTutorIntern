//
//  CardiologyExplanationViewController-iPad.m
//  Paramedic
//
...
@interface CardiologyExplanationViewController_iPad ()
...
@implementation CardiologyExplanationViewController_iPad
...
- (void)viewDidLoad {
    ...
    if (self.isHintButtonTapped) {
        ...
        buttonsContainerFrame.origin.x = self.backQuestionButton.frame.origin.x - 20;
        buttonsContainerFrame.size.width = self.backQuestionButton.frame.size.width + 40;
...
-(void) updateContainerView
{
    ...
    [self.explanationOrHintTextView setFont:[UIFont fontWithName:@"TimesNewRomanPS-ItalicMT" size:kiPadTextViewFontSize]];
